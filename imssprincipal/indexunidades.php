...
// Establece la conexión utilizando MySQLi
...
// Selecciona la base de datos utilizando MySQLi
if (!mysqli_select_db($conn, $dbname)) {
    die("No se pudo seleccionar la base de datos: " . mysqli_error($conn));
}

// A partir de aquí, puedes realizar operaciones en la base de datos utilizando $conn
