...
<?php 
$res=mysqli_query($conexiondb,"SELECT
a.del,
a.delegoumae,
...
$conr=mysqli_query($conexiondb,"SELECT
del, 
delegoumae,
...
while($row2=mysqli_fetch_array($conr))
{
...
$conpdf=mysqli_query($conexiondb,"SELECT
del, 
delegoumae,
pdf
FROM
...
while($row3=mysqli_fetch_array($conpdf))
{
	$delconpdf=$row3["del"];
